  ...
  return (
    <div className="planning-section-stack">
      ...
      <article className="panel table-panel">
        ...
        <div className="table-scroll planning-orders-table"><table><thead><tr><th>Reference</th><th>Product</th><th>Qty</th><th>Required</th><th>BOM</th><th>Readiness</th><th>Requirements</th><th /></tr></thead><tbody>{planning.productOrders.filter((order) => order.orderType === "PRODUCTION").map((order) => <Fragment key={order.id}>
        ...
        </Fragment>)}{planning.productOrders.every((order) => order.orderType !== "PRODUCTION") && <tr><td colSpan={8} className="empty-table">No product orders have been planned yet.</td></tr>}</tbody></table></div>
      </article>
    </div>
  );
}
